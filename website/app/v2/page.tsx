...
// V2: Gradient Hero - Enhanced with elements from v1, v5, v6, v7, v8
export default function V2GradientHero() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white overflow-hidden">
      {/* Gradient Background */}
      <div className="fixed inset-0 pointer-events-none dark:opacity-100 opacity-50">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm text-zinc-500 dark:text-zinc-400">
              ...
              <Link href="https://docs.mako.ai" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Documentation</Link>
              <Link href="https://github.com/mako-ai/mono" className="hover:text-zinc-900 dark:hover:text-white transition-colors">GitHub</Link>
            </div>
          </div>
          {/* Double button nav from v1 */}
          <div className="flex items-center gap-4">
            <a href="https://app.mako.ai" className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
              Sign in
            </a>
            <a
      ...
      <section className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 text-sm mb-8 backdrop-blur-sm">
            <span className="px-2 py-0.5 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white text-xs font-medium">NEW</span>
            <span className="text-zinc-600 dark:text-zinc-300">AI Agents for Database Queries</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              href="https://app.mako.ai"
              className="group w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-white font-semibold rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
              Start Building Free
      ...
      <section id="features" className="relative z-10 py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* AI Card - Large */}
            <div className="lg:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-purple-500/20 via-zinc-100 dark:via-zinc-900 to-zinc-100 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <div className="flex flex-col h-full">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 mb-6 flex-grow">
                  Describe what you need in plain English. Our AI understands your database
                  schema and writes optimized queries that actually work.
                </p>
                <div className="p-4 rounded-xl bg-white/50 dark:bg-zinc-900/80 font-mono text-sm">
                  <div className="text-zinc-400 dark:text-zinc-500 mb-2"># Ask anything</div>
                  <div className="text-purple-600 dark:text-purple-400">&quot;Show me users who haven&apos;t logged in for 30 days&quot;</div>
                  <div className="text-zinc-400 dark:text-zinc-500 mt-4">↓ AI generates</div>
            ...
            <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm">
                MIT licensed. Self-host it, fork it, customize it.
                Your data stays yours.
              </p>
              <div className="mt-6 flex items-center gap-2">
                <GitHubIcon className="w-5 h-5 text-zinc-400 dark:text-zinc-500" />
                <span className="text-sm text-zinc-400 dark:text-zinc-500">github.com/mako-ai/mono</span>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm">
                ...
                Version control your SQL snippets.
                Work together in real-time.
              </p>
              <div className="mt-6 flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-pink-500 border-2 border-zinc-100 dark:border-zinc-900" />
                <div className="w-8 h-8 rounded-full bg-purple-500 border-2 border-zinc-100 dark:border-zinc-900" />
                <div className="w-8 h-8 rounded-full bg-blue-500 border-2 border-zinc-100 dark:border-zinc-900" />
                <div className="w-8 h-8 rounded-full bg-zinc-300 dark:bg-zinc-700 border-2 border-zinc-100 dark:border-zinc-900 flex items-center justify-center text-xs">+5</div>
              </div>
            </div>

            {/* API Card - Large */}
            <div className="lg:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-pink-500/20 via-zinc-100 dark:via-zinc-900 to-zinc-100 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <div className="grid md:grid-cols-2 gap-8 h-full">
                <div>
                  <div className="text-4xl mb-4">⚡</div>
                  <h3 className="text-2xl font-bold mb-2">One-Click APIs</h3>
                  <p className="text-zinc-500 dark:text-zinc-400">
                    Turn any query into a REST endpoint instantly.
                    Perfect for dashboards, internal tools, and prototypes.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-white/50 dark:bg-zinc-900/80 font-mono text-sm">
                  <div className="text-zinc-400 dark:text-zinc-500">GET /api/v1/revenue</div>
            ...
            <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm">
                ...
                No downloads, no config, no updates.
                Just open and query.
              </p>
            </div>

            {/* Free Card */}
            <div className="p-8 rounded-3xl bg-gradient-to-br from-emerald-500/20 via-zinc-100 dark:via-zinc-900 to-zinc-100 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <div className="text-4xl mb-4">🆓</div>
              <h3 className="text-xl font-bold mb-2">Free Forever</h3>
              <p className="text-zinc-500 dark:text-zinc-400 text-sm">
                No credit card. No trial period.
                No feature gates. Just free.
              </p>
              <div className="mt-6">
                <span className="px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-sm">$0/month</span>
              </div>
            </div>

            {/* Blazing Fast Card - Large */}
            <div className="lg:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-orange-500/20 via-zinc-100 dark:via-zinc-900 to-zinc-100 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <div className="grid md:grid-cols-2 gap-8 h-full">
                <div>
                  <div className="text-4xl mb-4">🚀</div>
                ...
                <div className="flex flex-col justify-center gap-4">
                  <div className="flex items-center gap-4">
                    <span className="text-2xl font-bold text-orange-500 dark:text-orange-400">&lt;1s</span>
                    <span className="text-zinc-400 dark:text-zinc-500">startup time</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-2xl font-bold text-orange-500 dark:text-orange-400">60fps</span>
                    <span className="text-zinc-400 dark:text-zinc-500">smooth scrolling</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-2xl font-bold text-orange-500 dark:text-orange-400">0MB</span>
                    <span className="text-zinc-400 dark:text-zinc-500">disk space</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              ...
              <div className="mt-6 flex gap-2">
                <kbd className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs">⌘K</kbd>
                <kbd className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs">⌘↵</kbd>
                <kbd className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs">⌘S</kbd>
              </div>
            </div>
            ...
            {/* SSH Tunneling - Large */}
            <div className="lg:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-cyan-500/20 via-zinc-100 dark:via-zinc-900 to-zinc-100 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <div className="grid md:grid-cols-2 gap-8 h-full">
                <div>
                  <div className="text-4xl mb-4">🔐</div>
                ...
                <div className="p-4 rounded-xl bg-white/50 dark:bg-zinc-900/80 font-mono text-sm flex flex-col justify-center">
                  <div className="text-zinc-400 dark:text-zinc-500 mb-2"># Before (terminal hell)</div>
                  <div className="text-red-500 dark:text-red-400 line-through text-xs mb-4">ssh -L 5432:db:5432 bastion...</div>
                  <div className="text-zinc-400 dark:text-zinc-500 mb-2"># Now (one click)</div>
                  <div className="text-cyan-600 dark:text-cyan-400">✓ SSH tunnel connected</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              ...
              <div className="mt-6 flex gap-2">
                <span className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs text-zinc-500 dark:text-zinc-400">.csv</span>
                <span className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs text-zinc-500 dark:text-zinc-400">.json</span>
                <span className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-xs text-zinc-500 dark:text-zinc-400">.xlsx</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-24 px-6 border-t border-zinc-200 dark:border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-zinc-500 dark:text-zinc-400 text-center mb-12">
            Don&apos;t just take our word for it. *These are totally real testimonials.*
          </p>
      ...
      {/* Databases Section from v8 */}
      <section className="relative z-10 py-16 px-6 border-t border-zinc-200 dark:border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-8">Works with your favorite databases</h2>
          <div className="flex flex-wrap items-center justify-center gap-6">
            <DatabaseLogo name="PostgreSQL" />
            <DatabaseLogo name="MySQL" />
            <DatabaseLogo name="MongoDB" />
            <DatabaseLogo name="BigQuery" />
            <DatabaseLogo name="Snowflake" />
            <DatabaseLogo name="SQLite" />
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 py-24 px-6 border-t border-zinc-200 dark:border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="https://app.mako.ai"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-10 py-5 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-white font-bold text-lg rounded-lg hover:opacity-90 transition-opacity"
            >
              Get Started Free
    ...
    <div className="max-w-4xl mx-auto">
      <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900">
          ...
          <span className="text-xs text-zinc-400 dark:text-zinc-500">mako — production</span>
          <div className="w-16" />
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl bg-zinc-100 dark:bg-zinc-800/50 border border-zinc-200 dark:border-white/5 mb-6">
            <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 flex items-center justify-center text-sm text-white">
              ✨
            </div>
          ...
          <div className="font-mono text-sm text-left">
            <div className="text-zinc-400 dark:text-zinc-500 mb-2">-- AI Generated SQL</div>
            <div className="text-blue-600 dark:text-blue-400">SELECT <span className="text-zinc-800 dark:text-white">*</span></div>
            <div className="text-blue-600 dark:text-blue-400">FROM <span className="text-emerald-600 dark:text-emerald-400">users</span></div>
            <div className="text-blue-600 dark:text-blue-400">WHERE <span className="text-zinc-800 dark:text-white">created_at</span> <span className="text-pink-600 dark:text-pink-400">&gt;=</span> <span className="text-yellow-600 dark:text-yellow-400">NOW</span><span className="text-zinc-800 dark:text-white">() - </span><span className="text-orange-600 dark:text-orange-400">INTERVAL &apos;7 days&apos;</span></div>
            <div className="text-blue-600 dark:text-blue-400">ORDER BY <span className="text-zinc-800 dark:text-white">created_at</span> <span className="text-blue-600 dark:text-blue-400">DESC</span><span className="text-zinc-800 dark:text-white">;</span></div>
          </div>
...
function ComparisonRow({ label, mako, datagrip, dbeaver, postico }: {
  ...
  return (
    <tr className="border-b border-zinc-100 dark:border-zinc-800/50">
      ...
      <td className="text-center py-4 px-4 bg-purple-50/50 dark:bg-purple-500/5">{getIcon(mako)}</td>
...
function TestimonialCard({ quote, author, role, company }: {
  ...
  return (
    <div className="p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:shadow-lg transition-shadow">
      ...
      <p className="text-zinc-600 dark:text-zinc-300 mb-6">&quot;{quote}&quot;</p>
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-zinc-400 dark:text-zinc-500 text-xs">{role} at {company}</div>
        </div>
      </div>
    </div>
  );
...
function DatabaseLogo({ name }: { name: string }) {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700">
      <span className="text-lg">{icons[name] || "🗄️"}</span>
