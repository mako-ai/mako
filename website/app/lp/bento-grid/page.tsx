      ...
      <nav className="fixed top-0 w-full z-50 bg-neutral-950/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/mako-ai/mono" className="text-sm text-neutral-400 hover:text-white transition-colors hidden sm:block">
              GitHub
            </a>
            <a href="https://docs.mako.ai" className="text-sm text-neutral-400 hover:text-white transition-colors hidden sm:block">
              Docs
            </a>
            <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-violet-500/20 via-neutral-900 to-neutral-900 border border-neutral-800">
              <div className="flex flex-col h-full">
                ...
                <div className="p-4 rounded-xl bg-neutral-900/80 font-mono text-sm">
                  ...
                  <div className="text-violet-400">&quot;Show me users who haven&apos;t logged in for 30 days&quot;</div>
            ...
            <div className="p-8 rounded-3xl bg-neutral-900 border border-neutral-800">
              ...
              <div className="mt-6 flex items-center gap-2">
                ...
                <span className="text-sm text-neutral-500">github.com/mako-ai/mono</span>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-neutral-900 border border-neutral-800">
              ...
              <div className="mt-6 flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full bg-neutral-700 border-2 border-neutral-900 flex items-center justify-center text-xs">+5</div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 lg:col-span-1 p-8 rounded-3xl bg-neutral-900 border border-neutral-800">
              ...
              <p className="text-neutral-400 text-sm mb-6">
                PostgreSQL, MySQL, MongoDB, BigQuery, SQLite, and more.
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="w-10 h-10 rounded-lg bg-neutral-800 flex items-center justify-center text-xs text-neutral-500">+5</div>
              </div>
            </div>
      ...
      <footer className="py-12 px-6 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-neutral-400 text-sm">© 2025 Mako. MIT License.</span>
          </div>
