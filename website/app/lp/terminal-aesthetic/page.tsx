        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-lg border border-[#30363d] bg-[#161b22] overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-[#21262d] border-b border-[#30363d]">
              ...
              <span className="flex-1 text-center text-xs text-[#8b949e]">
                mako — zsh — 80x24
              </span>
            </div>
          ...
          <div className="rounded-lg border border-[#30363d] overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-[#21262d]">
                <tr>
                  <th className="text-left py-3 px-4 text-[#8b949e] font-normal">
                    Feature
                  </th>
                  <th className="text-center py-3 px-4 text-emerald-400">
                    mako
                  </th>
                  <th className="text-center py-3 px-4 text-[#8b949e]">
                    datagrip
                  </th>
                  <th className="text-center py-3 px-4 text-[#8b949e]">
                    dbeaver
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="rounded-lg border border-[#30363d] bg-[#161b22] p-8">
            <div className="text-lg mb-4">
              <span className="text-emerald-400">$</span> Ready to upgrade your
              database workflow?
            </div>
...
function TerminalTyping() {
  ...
  const lines = [
    ...
    {
      type: "prompt",
      text: '$ mako query --ai "show me revenue by month for 2024"',
    },
    ...
    {
      type: "output",
      text: "✓ API endpoint live at https://app.mako.ai/api/revenue",
    },
    { type: "prompt", text: "$ _" },
  ];
...
function CompareRow({
  ...
  return (
    <tr className="border-t border-[#30363d]">
      ...
      <td className="text-center py-3 px-4 text-emerald-400 bg-emerald-500/5">
        {mako}
      </td>
      {others.map((o, i) => (
        <td
          key={i}
          className={`text-center py-3 px-4 ${o === "✗" ? "text-red-400" : o === "~" ? "text-yellow-400" : "text-emerald-400"}`}
        >
          {o}
        </td>
      ))}
