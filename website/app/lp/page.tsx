...
export default function LandingPagesIndex() {
  const designs = [
    ...
    },
    {
      ...
      name: "Minimal Dark",
      description:
        "Ultra-clean dark design inspired by Cursor and Linear. Focused on code preview and developer trust signals.",
    ...
    },
    {
      ...
      description:
        "Developer-focused CLI vibes with typing animations. Appeals to power users and terminal enthusiasts.",
    ...
    },
    {
      ...
      name: "Split Screen",
      description:
        "Query editor on left, results on right. Shows the product in action immediately.",
    ...
    },
    {
      ...
      name: "Bento Grid",
      description:
        "Modern card-based layout showcasing features. Inspired by Apple and modern SaaS sites.",
    ...
    },
    {
      ...
      description:
        "Direct head-to-head comparison with DataGrip, DBeaver, Postico. Conversion-focused.",
    ...
    },
    {
      ...
      name: "Video Hero",
      description:
        "Large hero with video/animation showing AI in action. Visual proof of the product.",
      tags: ["Video", "Demo", "Visual"],
    },
    {
      slug: "testimonial-focus",
      name: "Testimonial Focus",
      description:
        "Social proof heavy with developer testimonials. Builds trust through peer validation.",
    ...
    },
    {
      ...
      description:
        "Hands-on demo widget in the hero. Users can try AI queries without signing up.",
      tags: ["Interactive", "Try Before Buy", "Engagement"],
    },
    {
      slug: "animated-features",
      name: "Animated Features",
      description:
        "Scroll-triggered animations and modern motion design. Premium feel with smooth transitions.",
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="border-b border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <Link
            href="/"
            className="text-sm text-zinc-500 hover:text-white transition-colors mb-4 inline-block"
          >
            ← Back to current site
          </Link>
          <h1 className="text-4xl font-bold mb-4">Landing Page Variants</h1>
          <p className="text-xl text-zinc-400 max-w-2xl">
            Alternative landing page designs for Mako. The Gradient Hero variant
            is currently live at the root.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="mt-8 p-8 rounded-2xl border border-zinc-800 bg-zinc-900/30">
          <h2 className="text-2xl font-bold mb-6">
            Core Value Propositions (12 total)
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Schema-aware AI writes optimized queries from natural language
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">👥</div>
              ...
              <p className="text-sm text-zinc-400">
                Shared connections, version-controlled snippets, real-time
                editing
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                MIT licensed, self-hostable, no feature gates
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">🚀</div>
              ...
              <p className="text-sm text-zinc-400">
                No Java/Electron bloat. Opens instantly, runs smooth
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Cmd+K palette, vim bindings, shortcuts for everything
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">📜</div>
              ...
              <p className="text-sm text-zinc-400">
                Every query saved and synced. Full-text search
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">🔒</div>
              ...
              <p className="text-sm text-zinc-400">
                Encrypted credentials, audit logs, PII masking
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">🔐</div>
              ...
              <p className="text-sm text-zinc-400">
                One-click tunnels to databases behind firewalls
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">⏰</div>
              ...
              <p className="text-sm text-zinc-400">
                Recurring queries with Slack/email/webhook delivery
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">📊</div>
              ...
              <p className="text-sm text-zinc-400">
                See query execution plans, find bottlenecks
              </p>
            </div>
            <div>
              <div className="text-2xl mb-2">📤</div>
              ...
              <p className="text-sm text-zinc-400">
                CSV, JSON, Excel, shareable links, charts
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-zinc-800 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-zinc-500">
          Preview all designs by clicking the cards above. Each design is a
