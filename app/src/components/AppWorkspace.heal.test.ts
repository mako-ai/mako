...
/**
 * Guard for apps.md §13.9: the workbench RENDERS state and starts processes
...
const src = readFileSync(
  path.join(path.dirname(fileURLToPath(import.meta.url)), "AppWorkspace.tsx"),
  "utf8",
);

describe("apps workbench never heals (apps.md §13.9)", () => {
