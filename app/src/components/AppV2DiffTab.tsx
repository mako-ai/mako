...
import { useAppsV2Store, type AppV2FileVersions } from "../store/appsV2Store";
import { focusAppsV2FileTab } from "../apps-v2-runtime/shell";
import { languageForPath } from "../app-runtime/monaco-jsx";

export default function AppV2DiffTab({
  appId,
  path,
  mode,
}: {
  ...
  const fetchFileVersions = useAppsV2Store(s => s.fetchFileVersions);
  ...
  const [versions, setVersions] = useState<AppV2FileVersions | null>(null);
      ...
      >
        ...
        {owner && (
          <Button
            ...
            onClick={() =>
              focusAppsV2FileTab(owner.app.id, owner.rel, owner.app.slug)
            }
          >
            Open file
          </Button>
