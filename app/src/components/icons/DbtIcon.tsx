 ...
 * to be substitutable for one. strokeWidth is accepted and unused — a filled
 * glyph has no strokes to widen.
 */
import { forwardRef } from "react";
import type { LucideIcon, LucideProps } from "lucide-react";

const DbtIcon = forwardRef<SVGSVGElement, LucideProps>(function DbtIcon(
  { size = 24, color = "currentColor", strokeWidth: _strokeWidth, ...rest },
  ref,
) {
  return (
    <svg
