/**
 * Chart Template Registry (frontend copy)
 *
 * The source of truth lives in api/src/agent-lib/tools/chart-templates.ts.
 * Keep both files in sync when making changes.
 *
 * Used by:
 * - Dashboard agent-tools.ts (get_chart_templates / get_chart_template)
 * - Chat.tsx onToolCall handler (get_chart_template)
 */
