...
### 3. Add Wildcard DNS Record (Required - Manual Step)

Go to Cloudflare Dashboard → **mako.ai** zone → **DNS** → **Records** and add:

| Type | Name | Content | Proxy |
|------|------|---------|-------|
| CNAME | `*` | `mako.ai` | Proxied (orange cloud) |

This creates a wildcard DNS record that catches all subdomains without explicit records (like `pr-27.mako.ai`).
