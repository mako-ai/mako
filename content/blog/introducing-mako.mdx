...
Mako is MIT licensed and free to use. No credit card, no trial period, no feature gates. Run it in the cloud at [app.mako.ai](https://app.mako.ai) or self-host it from the [GitHub repo](https://github.com/mako-ai/mono).
