...
import { agentV2Routes } from "./routes/agent-v2.routes";
import { agentV3Routes } from "./routes/agent-v3.routes";
...
app.route("/api/agent", agentV2Routes);
app.route("/api/agent-v3", agentV3Routes);
