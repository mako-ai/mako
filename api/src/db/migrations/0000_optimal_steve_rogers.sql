...
ALTER TABLE "console_folders" ADD CONSTRAINT "console_folders_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "saved_consoles" ADD CONSTRAINT "saved_consoles_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "saved_consoles" ADD CONSTRAINT "saved_consoles_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "chat_attachments" ADD CONSTRAINT "chat_attachments_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "chats" ADD CONSTRAINT "chats_pinned_console_id_saved_consoles_id_fk" FOREIGN KEY ("pinned_console_id") REFERENCES "public"."saved_consoles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
